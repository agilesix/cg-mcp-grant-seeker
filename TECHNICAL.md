...
How the CommonGrants MCP app works under the hood. For installing and using the
app, see [README.md](README.md). For running it locally and deploying it, see
...
- [CONTRIBUTING.md](CONTRIBUTING.md) — project conventions and how to contribute
