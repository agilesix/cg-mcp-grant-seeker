import { createAppServer } from './app/hosts/skybridge/server.js';
...
const healthPaths = process.env.NODE_ENV === 'production' ? ['/', '/health'] : '/health';

server.express.get(healthPaths, (_request: Request, response: Response) => {
